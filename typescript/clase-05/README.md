# Clase 05: Construye el chatbot con interfaz de terminal

**Objetivo:** Unir historial, persistencia, streaming y manejo de errores.
...
npm --prefix typescript run clase:05:final
```
