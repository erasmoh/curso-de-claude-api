# Clase 04: Streaming de respuestas en tiempo real

**Objetivo:** Mostrar texto incrementalmente mientras Claude responde.
...
npm --prefix typescript run clase:04:final
```
