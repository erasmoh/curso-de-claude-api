...
Esta rama es el checkpoint **final** de la clase 03.

Solución completa y comentada de la clase.

## Contenido de esta rama

- `python/clase-03/final/main.py` — versión Python (ruta principal).
- `typescript/clase-03/final/main.ts` — versión TypeScript (ruta alternativa).
...
# Python
python python/clase-03/final/main.py

# TypeScript
cd typescript && npm install && npm run clase:03:final
```
