...
Esta rama es el checkpoint **final** de la clase 12.

Solución completa y comentada de la clase.

## Contenido de esta rama

- `python/clase-12/final/main.py` — versión Python (ruta principal).
- `typescript/clase-12/final/main.ts` — versión TypeScript (ruta alternativa).
...
# Python
python python/clase-12/final/main.py

# TypeScript
cd typescript && npm install && npm run clase:12:final
```
